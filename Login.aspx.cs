...
public partial class Login : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["Add"] == "Data")
        {
            Page.ClientScript.RegisterStartupScript(GetType(), "msgtype", "alert('Enregistrement réussi. Vous pouvez vous connecter maintenant')", true);
            Session["Add"] = "";
        }
        if (Session["Login"] == "Data")
        {
            Page.ClientScript.RegisterStartupScript(GetType(), "msgtype", "alert('Votre session de connexion a expiré. Veuillez vous reconnecter pour continuer...')", true);
            Session["Login"] = "";
        }
    }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            Label2.Visible = true;
            Label2.Text = "Matricule n'existe pas !";
