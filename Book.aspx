     ...
     <table style="width:100%">
            <tr>
                <td align="center" colspan="3">
                    <asp:Image ID="Image1" runat="server" Width="100%" ImageUrl="~/Images/temp3.png" />
                </td>
            </tr>
         <tr>
    <td colspan="3">
        ...
        <ul id="css3menu1" class="topmenu">
            ...
            <tr>
                ...
                <td align="center" style="width: 80%; background-color: #CCCCCC;">
                    <asp:Label ID="Label1" runat="server" style="font-family: gadugi; font-size: xx-large" Text="Réserver une place"></asp:Label>
                </td>
    ...
    <table width="100%">
        <tr>
            <td align="center" colspan="4">
                <asp:Label ID="Label2" runat="server" style="font-family: gadugi; font-size: large" Text="Sélectionner une date :"></asp:Label>
        ...
        <tr>
            <td align="right" width="30%">
                <asp:Label ID="Label3" runat="server" style="font-family: gadugi; font-size: large" Text="Heure de début :"></asp:Label>
            </td>
            ...
            <td align="right" width="20%">
                <asp:Label ID="Label4" runat="server" style="font-family: gadugi; font-size: large" Text="Combien de temps :"></asp:Label>
            </td>
            <td align="left">
        ...
        <tr>
            <td align="center" colspan="4">
                <asp:Button ID="Button284" runat="server" style="font-family: gadugi; font-size: 1.2em; padding: 10px 20px; background-color: #4CAF50; color: white; border: none; border-radius: 4px; cursor: pointer; width: 20%;" Text="Réserver " OnClick="Button284_Click" Width="20%" />
            </td>
        </tr>
        <tr>
            <td align="center" colspan="4">
...
&nbsp;<br />
    ...
    <td colspan="2" style="background-color: #262523; color: #FFFFFF; font-family:Gadugi;" align="right">
        <asp:Label ID="Label5" runat="server" CssClass="auto-style1" Text="ParkEasy "></asp:Label>
        <asp:Label ID="Label6" runat="server" CssClass="auto-style1" Text="|| Chihab & Soufiane &nbsp;&nbsp;&nbsp;"></asp:Label>
        &nbsp;&nbsp; 
    </td>
    </tr>
    </table>
