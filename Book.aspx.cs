...
public partial class Book : System.Web.UI.Page
{
    ...
    public void btn(Button id)
    {
        ...
        {
            if (LabelSec.Text == "Zone d'entrée principale" || LabelSec.Text == "Zone Porte principale ")
            {
            ...
            else if (LabelSec.Text == "Zone Deuxième porte")
            {
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    string slot = ds.Tables[0].Rows[i][1].ToString();
            ...
            else if (LabelSec.Text == "Zone Porte principale")
            {
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    string slot = ds.Tables[0].Rows[i][1].ToString();
    ...
    protected void Button285_Click(object sender, EventArgs e)
    {
        if (TextBox1.Text != "")
        {
            if (DropDownList1.Text != "--Select--")
            {
                if (DropDownList2.Text != "--Select--")
                {
                    ...
                    {
                        LabelErr2.Text = "Veuillez sélectionner un créneau";
                ...
                {
                    LabelErr1.Text = "Veuillez sélectionner la durée souhaitée en heures";
            ...
            {
                LabelErr.Text = "Veuillez sélectionner l'heure de début";
        ...
        {
            LabelErr0.Text = "Veuillez sélectionner la date";
    ...
    protected void Button284_Click(object sender, EventArgs e)
    {
        if (TextBox1.Text != "")
        {
            ...
            if (s1 >= s)
            {
                if (DropDownList1.Text != "--Select--")
                {
                    if (DropDownList2.Text != "--Select--")
                    {
                        ...
                        if (Session["Value"] == "Zone Arrière du collège")
                        {
                            LabelSec.Text = Session["Value"].ToString();
                            Panel1.Visible = true;
                        }
                        else if (Session["Value"] == "Zone Deuxième porte")
                        {
                            LabelSec.Text = Session["Value"].ToString();
                            Panel1.Visible = true;
                        }
                        ...
                        else if (Session["Value"] == "Zone Porte principale")
                        {
                            LabelSec.Text = Session["Value"].ToString();
                            Panel4.Visible = true;
                        }
                        ...
                        if (Convert.ToInt32(split[0]) <= 18)
                        {
                            ...
                            if (ds.Tables[0].Rows.Count > 0)
                            {
                                if (LabelSec.Text == "Zone Arrière du collège" || LabelSec.Text == "Zone Deuxième porte")
                                {
                                    for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                                    {
                                        string slot = ds.Tables[0].Rows[i][1].ToString();
                        ...
                        {
                            LabelErr2.Text = "L'heure ne doit pas dépasser 18h00";
                            LabelErr2.Visible = true;
                            Panel1.Visible = false;
                            Panel3.Visible = false;
                            Panel4.Visible = false;
            ...
            {
                LabelErr0.Text = "La date sélectionnée doit être actuelle ou future";
                LabelErr0.Visible = true;
                LabelErr.Visible = false;
                LabelErr1.Visible = false;
                LabelErr2.Visible = false;
