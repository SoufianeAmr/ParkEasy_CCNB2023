     ...
     <table width="100%">
        ...
        <tr>
            <td style="text-align: right; width: 15%;">
                <asp:Label ID="Label1" runat="server" style="font-family: gadugi; font-size: large" Text="Matricule :"></asp:Label>
            </td>
            ...
            <td style="text-align: right; width: 25%;">
                <asp:Label ID="Label2" runat="server" style="font-family: gadugi; font-size: large" Text="Nom Etudiant:"></asp:Label>
            </td>
            <td style="text-align: center; width: 25%;">
        ...
        <tr>
            <td style="text-align: right; width: 15%;">
                <asp:Label ID="Label3" runat="server" style="font-family: gadugi; font-size: large" Text="Cellulaire: "></asp:Label>
            </td>
        ...
        <tr>
            <td style="text-align: right; width: 15%;">
                <asp:Label ID="Label5" runat="server" style="font-family: gadugi; font-size: large" Text="Programme :"></asp:Label>
            </td>
            <td style="text-align: center">
                <asp:TextBox ID="TextBox5" Required="" runat="server" Height="35px" style="font-size: large; font-family: gadugi" Width="100%"></asp:TextBox>
            </td>
            <td style="text-align: right; width: 25%;">
                <asp:Label ID="Label6" runat="server" style="font-family: gadugi; font-size: large" Text="Date de Naissance:"></asp:Label>
            </td>
            <td style="text-align: center">
        ...
        <tr>
            <td style="text-align: right; " colspan="2">
                <asp:Label ID="Label7" runat="server" style="font-family: gadugi; font-size: large" Text="Sexe :"></asp:Label>
            </td>
            <td style="text-align: right; " colspan="2">
        ...
        <br />
        <asp:Button ID="Button1" runat="server" Height="35px" OnClick="Button1_Click" style="font-family: gadugi; font-size: large" Text="Ajouter" Width="20%" />
        <br />
&nbsp;&nbsp;<br />
        </center>
</asp:Content>
